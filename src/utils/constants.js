// Lot sizes for F&O stocks and indices
...
// Index underlyings
export const INDEX_OPTIONS = ['NIFTY', 'BANKNIFTY', 'FINNIFTY', 'MIDCPNIFTY', 'NIFTYNXT50', 'SENSEX', 'BANKEX'];

// All underlyings list (Indices first, then alphabetically sorted stocks)
const STOCK_OPTIONS = Object.keys(LOT_SIZES).filter(key => !INDEX_OPTIONS.includes(key)).sort();
export const ALL_UNDERLYINGS = [...INDEX_OPTIONS, ...STOCK_OPTIONS];
